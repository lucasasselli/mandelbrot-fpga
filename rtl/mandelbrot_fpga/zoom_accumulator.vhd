-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mandelbrot_fpga\zoom_accumulator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: zoom_accumulator
-- Source Path: mandelbrot_fpga/mandelbrot_top/keyboard_handler /zoom_accumulator
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END zoom_accumulator;


ARCHITECTURE rtl OF zoom_accumulator IS
...
BEGIN
  ...
  BEGIN
    IF i_reset_n = '0' THEN
      Unit_Delay_Enabled_Synchronous_out1 <= to_signed(16#08000#, 18);
    ELSIF i_clk'EVENT AND i_clk = '1' THEN
